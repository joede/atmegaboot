/* config_RFIDLOCK.h -- product specific bootloader configuration header.
 *
...
#define INIT_PORT_A
#define DIR_PORT_A  BIN2BYTE(00011110)
#define VAL_PORT_A  BIN2BYTE(01100000)

#define INIT_PORT_B
#define DIR_PORT_B  BIN2BYTE(11111110)
#define VAL_PORT_B  BIN2BYTE(00011001)

#define INIT_PORT_C
#define DIR_PORT_C  BIN2BYTE(11001111)
#define VAL_PORT_C  BIN2BYTE(00110000)

#define INIT_PORT_D
#define DIR_PORT_D  BIN2BYTE(11111011)
#define VAL_PORT_D  BIN2BYTE(10001100)
